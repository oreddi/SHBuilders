    ...
    <div className="inner">
      <div className="split-grid">
        <div className="reveal in">
          ...
          <Link href="/company" className="btn-outline" style={{ marginTop: '40px', color: '#000', borderColor: '#000', display: 'inline-block' }}>
            Our Company
          </Link>
        </div>
...
export const ProcessVideo = () => (
  <div className="vid-strip reveal in" style={{ height: '50vh', minHeight: '400px', margin: '40px 0' }}>
    <video autoPlay muted loop playsInline style={{ filter: 'brightness(0.7)', width: '100%', height: '100%', objectFit: 'cover' }}>
